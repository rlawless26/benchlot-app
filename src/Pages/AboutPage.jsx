  ...
  return (
    <div className="bg-base min-h-screen">
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            <div className="md:w-1/3">
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                />
                <div className="p-4">
                  <h3 className="font-serif text-xl font-medium text-text-primary">Rob</h3>
        ...
        {/* Our Mission Section */}
        <div className="mb-20">
          <h2 className="text-3xl font-serif font-medium text-text-primary mb-6 text-center">
            Our Mission
          </h2>
          
          <div className="bg-white p-8 rounded-lg shadow-md">
            <p className="text-xl text-center text-text-secondary italic">
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-serif font-medium text-text-primary mb-10 text-center">
            What Makes Benchlot Different
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard 
              icon={<Hammer className="h-8 w-8 text-forest-700" />}
            ...
            <FeatureCard 
              icon={<Users className="h-8 w-8 text-forest-700" />}
            ...
            <FeatureCard 
              icon={<ShoppingBag className="h-8 w-8 text-forest-700" />}
        ...
        <div className="mb-20">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 h-full w-1 bg-forest-200"></div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="/marketplace" 
              className="px-6 py-3 bg-forest-700 text-white rounded-md hover:bg-forest-800 inline-flex items-center justify-center"
            >
            ...
            <a 
              href="/listtool"
              className="px-6 py-3 bg-white border border-forest-300 text-forest-700 rounded-md hover:bg-forest-50 inline-flex items-center justify-center"
            >
...
const FeatureCard = ({ icon, title, description }) => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <h3 className="text-xl font-serif font-medium text-text-primary mb-2 text-center">
        {title}
      </h3>
...
const TimelineItem = ({ year, title, description, align }) => {
    return (
      <div className={`relative flex items-start ${align === 'right' ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
        {/* Timeline dot */}
        <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-7 h-7 rounded-full bg-forest-700 border-4 border-white z-10"></div>
        
        {/* Content */}
        <div className={`md:w-1/2 ${align === 'right' ? 'md:pr-20' : 'md:pl-20'} pl-20 md:pr-20`}>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-2">
              <Calendar className="h-5 w-5 text-forest-700 mr-2" />
              <span className="text-forest-700 font-medium">{year}</span>
            </div>
