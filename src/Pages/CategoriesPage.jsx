        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {categories.map((category, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-serif font-medium text-forest-800 mb-4">
                <Link 
                ...
                {category.subcategories.map((subcategory, subIndex) => (
                  <li key={subIndex}>
                    <Link 
                      ...
                      className="text-stone-700 hover:text-forest-700 transition-colors"
                    >
                      {subcategory}
                    </Link>
                  </li>
              ...
              {['DeWalt', 'Milwaukee', 'Makita', 'Bosch', 'Stanley', 'Festool', 'Lie-Nielsen', 'Veritas', 'Jet', 'Delta', 'Ridgid', 'Ryobi'].map((brand, index) => (
                <div key={index} className="text-center">
                  <Link 
                    ...
                    className="block p-4 text-stone-700 hover:text-forest-700 transition-colors"
                  >
                    {brand}
                  </Link>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {['New', 'Like New', 'Excellent', 'Very Good', 'Good', 'Fair'].map((condition, index) => (
              <Link 
                ...
                className="bg-white rounded-lg shadow-md p-6 text-center hover:bg-forest-50 transition-colors"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="h-48 bg-forest-100 flex items-center justify-center">
                <span className="text-xl font-serif text-forest-800">Featured Tools</span>
              </div>
              <div className="p-4 group-hover:bg-forest-50 transition-colors">
            ...
            >
              <div className="h-48 bg-forest-100 flex items-center justify-center">
                <span className="text-xl font-serif text-forest-800">Budget Finds</span>
              </div>
              <div className="p-4 group-hover:bg-forest-50 transition-colors">
            ...
            >
              <div className="h-48 bg-forest-100 flex items-center justify-center">
                <span className="text-xl font-serif text-forest-800">Verified Tools</span>
              </div>
              <div className="p-4 group-hover:bg-forest-50 transition-colors">
