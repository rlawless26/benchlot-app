      ...
      <div className="border-b bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 h-8 flex items-center justify-between text-sm">
          <div className="flex items-center gap-4">
            <span className="text-stone-600">Boston</span>
            <span className="text-stone-600">Updates</span>
            <span className="text-stone-600">Help</span>
          </div>
          <div className="flex items-center gap-4">
            <span className="text-stone-600">Sell on Benchlot</span>
            ...
            <nav className="hidden lg:flex items-center gap-6">
              {categories.map((category) => (
                <div key={category.name} className="relative group">
                  <button className="flex items-center gap-1 text-stone-700 hover:text-orange-700">
                  ...
                  <div className="absolute left-0 top-full mt-1 bg-white shadow-lg rounded-md p-2 min-w-[200px] hidden group-hover:block z-10">
                    {category.subcategories.map((sub) => (
                      <a
                        key={sub}
                        href="#"
                        className="block px-4 py-2 text-stone-700 hover:bg-orange-50 hover:text-orange-700 rounded-md"
                      >
                        {sub}
                      </a>
                    ))}
          ...
          <div className="flex items-center gap-4">
            {!loading && (
              user ? (
                ...
                <>
                  <button className="text-stone-700 hover:text-orange-700">
                  ...
                  <div className="relative">
                    <button 
                      className="text-stone-700 hover:text-orange-700 relative"
                    ...
                    {profileMenuOpen && (
                      <div className="absolute right-0 top-full mt-1 bg-white shadow-lg rounded-md p-2 min-w-[200px] z-10">
                        ...
                        <Link to="/profile/me" className="flex items-center gap-3 w-full text-left px-4 py-2 text-stone-700 hover:bg-orange-50 hover:text-orange-700 text-sm">
                        ...
                        <Link to="/wishlist" className="flex items-center gap-3 w-full text-left px-4 py-2 text-stone-700 hover:bg-orange-50 hover:text-orange-700 text-sm">
                          <Heart className="h-4 w-4" />
                          Saved Tools
                        </Link>
                        
                        <Link to="/settings" className="flex items-center gap-3 w-full text-left px-4 py-2 text-stone-700 hover:bg-orange-50 hover:text-orange-700 text-sm">
                        ...
                        <button 
                          ...
                          className="flex items-center gap-3 w-full text-left px-4 py-2 text-stone-700 hover:bg-orange-50 hover:text-orange-700 text-sm"
                        >
                ...
                <div className="flex items-center gap-4">
                  <Link to="/login" className="text-stone-700 hover:text-orange-700">
                    Log In
                  </Link>
                  <Link 
                    to="/signup"
              ...
              {!loading && (
                user ? (
                  <div className="space-y-3">
                    <Link to="/profile/me" className="flex items-center gap-3 py-2 text-stone-700 hover:text-orange-700">
                      <User className="h-5 w-5" />
                      My Profile
                    </Link>
                    <Link to="/my-listings" className="flex items-center gap-3 py-2 text-stone-700 hover:text-orange-700">
                      <Hammer className="h-5 w-5" />
                      My Listings
                    </Link>
                    <Link to="/wishlist" className="flex items-center gap-3 py-2 text-stone-700 hover:text-orange-700">
                      <Heart className="h-5 w-5" />
                      Saved Tools
                    </Link>
                    ...
                    <button 
                      onClick={handleLogout}
                      className="flex items-center gap-3 py-2 text-stone-700 hover:text-orange-700"
                    >
                  ...
                  <div className="space-y-3">
                    <Link to="/login" className="block py-2 text-stone-700 hover:text-orange-700">
                      Log In
                    </Link>
                    <Link to="/signup" className="block py-2 text-stone-700 hover:text-orange-700">
                      Sign Up
                    </Link>
                  </div>
                )
