...
CREATE POLICY "Anonymous users can access cart items through session_id" ON "public"."cart_items" USING (((( SELECT "c"."session_id"
   FROM "public"."carts" "c"
  WHERE ("c"."id" = "cart_items"."cart_id")) IS NOT NULL) AND ("auth"."role"() = 'anon'::"text"))) WITH CHECK (((( SELECT "c"."session_id"
   FROM "public"."carts" "c"
  WHERE ("c"."id" = "cart_items"."cart_id")) IS NOT NULL) AND ("auth"."role"() = 'anon'::"text")));



CREATE POLICY "Anonymous users can access carts by session_id" ON "public"."carts" USING ((("session_id" IS NOT NULL) AND ("auth"."role"() = 'anon'::"text"))) WITH CHECK ((("session_id" IS NOT NULL) AND ("auth"."role"() = 'anon'::"text")));



CREATE POLICY "Anonymous users can view tools" ON "public"."tools" FOR SELECT TO "anon" USING (("is_sold" = false));
...
CREATE POLICY "Authenticated users can view available tools" ON "public"."tools" FOR SELECT TO "authenticated" USING (("is_sold" = false));
...
CREATE POLICY "Service role can do anything with cart items" ON "public"."cart_items" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Service role can do anything with carts" ON "public"."carts" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Service role can do anything with tools" ON "public"."tools" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "Users can add items to carts" ON "public"."cart_items" FOR INSERT WITH CHECK ((( SELECT "carts"."user_id"
   FROM "public"."carts"
  WHERE ("carts"."id" = "cart_items"."cart_id")) = "auth"."uid"()));
...
CREATE POLICY "Users can delete items from carts" ON "public"."cart_items" FOR DELETE USING ((( SELECT "carts"."user_id"
   FROM "public"."carts"
  WHERE ("carts"."id" = "cart_items"."cart_id")) = "auth"."uid"()));
...
CREATE POLICY "Users can update items in carts" ON "public"."cart_items" FOR UPDATE USING ((( SELECT "carts"."user_id"
   FROM "public"."carts"
  WHERE ("carts"."id" = "cart_items"."cart_id")) = "auth"."uid"()));
...
CREATE POLICY "Users can view items in own carts" ON "public"."cart_items" FOR SELECT USING ((( SELECT "carts"."user_id"
   FROM "public"."carts"
  WHERE ("carts"."id" = "cart_items"."cart_id")) = "auth"."uid"()));
